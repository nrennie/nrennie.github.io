...
author:
  - name: Nicola Rennie
preview: images/final_plot.jpeg
date: 2021-12-18
twitter:
  site: "@nrennie35"
...
```{r, echo=FALSE}
library(tweetrmd)
tweet_embed("https://twitter.com/WeAreRLadies/status/1470792871242522631")
```
...
```{r, echo=FALSE,out.width="75%",out.height="75%",fig.show='hold', fig.align="center", fig.cap="Image from tenor.com/view/wannabe-spice-girls-gif-13245102"} 
knitr::include_graphics(c("images/spice.gif"))  
```
...
knitr::include_graphics(c("images/basic_plot.jpeg"))  
```
...
```{r, echo=FALSE,out.width="75%",out.height="75%",fig.show='hold', fig.align="center"} 
knitr::include_graphics(c("images/final_plot.jpeg"))  
```
